module "loadbalancer" {
  ...
  server_id_pim           = try(data.terraform_remote_state.tfstate-vm.outputs.server_id_pim, null)
...
module "firewall" {
  ...
  server_id_rabbitmq          = data.terraform_remote_state.tfstate-services.outputs.server_id_rabbitmq
  server_id_rds               = data.terraform_remote_state.tfstate-services.outputs.server_id_rds
  server_id_redis             = data.terraform_remote_state.tfstate-services.outputs.server_id_redis
  server_id_elasticsearch     = data.terraform_remote_state.tfstate-services.outputs.server_id_elasticsearch
}
